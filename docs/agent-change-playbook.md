...
- Inspect first: `state_contract.py`, `app.py`, `app_i18n.py`, `renderer.py`, `datamosh.py`, `ffmpeg_utils.py`, `still_cache.py`, project save/load code, settings defaults and migration behavior.
